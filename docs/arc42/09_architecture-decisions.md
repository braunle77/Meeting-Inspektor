...
Alle Entscheidungen liegen als ADRs in [docs/adr/](../adr/), eine Datei pro Entscheidung:

- [0001 – Eine einzige HTML-Datei, kein Build, kein Server](../adr/0001-single-html-file-no-build.md)
